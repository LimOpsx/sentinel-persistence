...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.gw.api.GatewayApiRuleNacosProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.gw.api.GatewayApiRuleNacosPublisher;
...
public class GatewayApiController {
    ...
    private void publishRules(String app) throws Exception {
        ...
        this.gatewayApiRuleNacosPublisher.publish(app, rules);
    }
}
