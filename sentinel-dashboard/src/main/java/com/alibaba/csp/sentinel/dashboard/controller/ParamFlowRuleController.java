...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.param.flow.ParamFlowRuleNacosProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.param.flow.ParamFlowRuleNacosPublisher;
...
public class ParamFlowRuleController {
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            ...
            List<ParamFlowRuleEntity> rules = this.paramFlowRuleNacosProvider.getRules(app);
    ...
    private void publishRules(String app) throws Exception {
        ...
        this.paramFlowRuleNacosPublisher.publish(app, rules);
    }
